const QUERY = {
  ...
  CREATE_PATIENT:
    "INSERT INTO patients(first_name, last_name, email, addr, diagnosis, phone,img_url) VALUES(?,?,?,?,?,?,?)",
  UPDATE_PATIENT:
    "UPDATE patients SET first_name=?, last_name=?, email=?, addr=?, diagnosis=?, phone=?,img_url=? WHERE id = ?",
